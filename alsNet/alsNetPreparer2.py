        ...
        for file in glob.glob(file_pattern):
            ...
            while True:
                ...
                if points_and_features is not None:
                    ...
                    dataset.Dataset.SaveWithWaves(out_path, points_and_features[0][idx_to_use], names,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--kNN', default=50000, type=int, required=True, help='how many points per batch [default: 200000]')
