...
import numpy as np
import argparse
from alsNetRefactored_fw3 import AlsNetContainer, simple_loss, fp_high_loss
...
def main(args):
    ...
    inst = AlsNetContainer(num_feat=160, num_classes=6, num_points=10000, output_base=args.outDir, score_sample=10,
                           arch=arch,
                           learning_rate=lr,
                           dropout=0.55,
