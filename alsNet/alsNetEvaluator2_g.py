...
from alsNetRefactored_fw2 import AlsNetContainer
...
def main(args):
    ...
    model = AlsNetContainer(num_feat=160, num_classes=6, num_points=50000, output_base=args.outDir, arch=arch1, arch2=arch2)
