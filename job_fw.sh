...
python ./alsNet/alsNetRunner6.py --inList ./data/train_fw_patch/stats.csv --threshold 20 --minBuild 0 --learningRate 0.0001 --outDir ./logs_models/ --archFile archs.arch4
